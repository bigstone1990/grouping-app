<script setup>
import GroupListItemForCreate from './GroupListItemForCreate.vue';
...
<template>
  <article class="GroupListWrapper">
    ...
    <div class="GroupListContainer">
      <div class="GroupList">
        <GroupListItemForCreate v-for="group in props.groups" :key="group.group_id" v-model:sortable="sortable" v-model:dropzones="dropzones" v-model:dropzoneContainer="dropzoneContainer" :group="group" />
      </div>
    </div>
  </article>
</template>
