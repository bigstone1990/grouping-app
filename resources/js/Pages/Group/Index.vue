              ...
              <div class="container mx-auto">
                <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                  ...
                  <table class="table-auto w-full text-left whitespace-no-wrap">
                    <thead>
                      <tr>
                        <th class="w-20 px-4 py-3 title-font tracking-wider font-medium text-gray-100 text-sm bg-gray-900 rounded-tl rounded-bl">順番</th>
                        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-100 text-sm bg-gray-900">グループ名</th>
                        <th class="w-28 px-4 py-3 title-font tracking-wider font-medium text-gray-100 text-sm bg-gray-900 rounded-tr rounded-br">操作</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr v-for="group in props.groups" :key="group.id">
                        ...
                        <td class="border-b-2 px-4 py-3 flex justify-center">
                          <Link as="button" :href="route('groups.edit', {group: group.id})" class="text-white bg-green-500 border-0 py-2 px-4 focus:outline-none hover:bg-green-600 rounded">編集</Link>
                        </td>
                      </tr>
                    </tbody>
                  </table>
